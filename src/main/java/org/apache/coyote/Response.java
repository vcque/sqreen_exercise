...
/**
 * This class overrides the default Tomcat Coyote Response class by dropping it into the $CATALINA_HOME/lib folder.
 * 
 * It adds the "X-Instrumented-By: Sqreen" header to any reponse in the {@link Response#sendHeaders()} method.
 * 
 * As we replace the tomcat class completely by this one, any other behavior/code of the original {@link Response} must be duplicated. 
 * It means that this solution only works for a specific version of Tomcat (6.0.48) and might break for any other version in undefined fashion : best case an exception, worst case silent changes of its behavior.
 */
public final class Response {
    ...
    public void sendHeaders() throws IOException {
        this.addHeader("X-Instrumented-By", "Sqreen");
